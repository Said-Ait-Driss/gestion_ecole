                ...
                <div class="card-body">
                    ...
                    <form action="store" method="POST" class="row needs-validation">
                        ...
                        <div class="mb-3 col-lg-6">
                            ...
                            <input type="date" class="form-control <?php if(array_key_exists('date', $errors)){ echo "is-invalid"; } ?>" id="date"  placeholder="Date de naissance" name="dateBirth">
                            <div class="invalid-feedback">
                               <?= $errors["date"]; ?>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 col-lg-6">
                            ...
                            <input type="text" class="form-control <?php if(array_key_exists('ville', $errors)){ echo "is-invalid"; } ?>" id="ville" placeholder="Ville" name="city">
                            <div class="invalid-feedback">
                               <?= $errors["ville"]; ?>
                            </div>
                        </div>
